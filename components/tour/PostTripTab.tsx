...
const headingStyle: React.CSSProperties = { fontSize: 15, fontWeight: 700, color: BRAND.navy, fontFamily: "'Fjalla One',Georgia,sans-serif", letterSpacing: "0.03em", marginBottom: 12 };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {DEBRIEF_FIELDS.map(({ key, label, placeholder }) => (
        <div key={key} style={cardStyle}>
          <div style={{ fontSize: 13, fontWeight: 700, color: BRAND.navy, fontFamily: "'Fjalla One',Georgia,sans-serif", letterSpacing: "0.03em", marginBottom: 8 }}>{label}</div>
          <Tex
      ...
      <div style={{ background: "#f8fafc", border: "1.5px dashed #e2e8f0", borderRadius: 12, padding: 16, opacity: 0.85 }}>
        <div style={{ fontSize: 15, fontWeight: 700, color: "#94a3b8", fontFamily: "'Fjalla One',Georgia,sans-serif", letterSpacing: "0.03em", marginBottom: 4 }}>
          Social / Share
        </div>
...
function Label({ children }: { children: React.ReactNode }) {
  return <div style={{ fontSize: 13, fontWeight: 700, color: BRAND.navy, fontFamily: "'Fjalla One',Georgia,sans-serif", letterSpacing: "0.03em", marginBottom: 8 }}>{children}</div>;
}

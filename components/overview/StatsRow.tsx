    ...
    <section style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, minmax(0, 1fr))", gap: 12 }}>
        {STATUSES.map(st => (
          ...
          >
            ...
            <div style={{ fontSize: 32, fontWeight: 400, color: BRAND.navy, lineHeight: 1, fontFamily: "'Fjalla One', Georgia, sans-serif" }}>
              {counts[st.id]}
            </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
        ...
        >
          ...
          <div style={{ fontSize: 26, fontWeight: 400, color: "#cbd5e1", lineHeight: 1, fontFamily: "'Fjalla One', Georgia, sans-serif" }}>
            —
          </div>

      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 24px 80px rgba(0,0,0,0.3)" }}>
          <div style={{ padding: "28px 32px 22px", textAlign: "center", borderBottom: "1px solid #f1f5f9" }}>
            ...
            <div style={{ fontFamily: "'Fjalla One', Georgia, sans-serif", letterSpacing: "0.03em", fontWeight: 700, fontSize: 18, color: BRAND.navy }}>
              {tourName}
            </div>
          ...
          <div style={{ padding: "28px 32px 32px" }}>
            <h2 style={{ fontFamily: "'Fjalla One', Georgia, sans-serif", fontSize: 20, fontWeight: 700, color: BRAND.navy, margin: "0 0 6px" }}>
              View Itinerary
            </h2>
